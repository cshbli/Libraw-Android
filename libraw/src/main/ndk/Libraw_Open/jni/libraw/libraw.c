...
JNIEXPORT void JNICALL Java_com_deepvi_libraw_Libraw_cleanup(JNIEnv * env, jobject obj){
	cleanup();
}
JNIEXPORT jint JNICALL Java_com_deepvi_libraw_Libraw_open(JNIEnv * env, jobject obj,jstring file){
	cleanup();
...
JNIEXPORT jint JNICALL Java_com_deepvi_libraw_Libraw_getWidth(){
	return librawData->sizes.width;
	
}
JNIEXPORT jint JNICALL Java_com_deepvi_libraw_Libraw_getBitmapWidth(){
	return image->width;
}
JNIEXPORT jint JNICALL Java_com_deepvi_libraw_Libraw_getBitmapHeight(){
	return image->height;
}

JNIEXPORT jint JNICALL Java_com_deepvi_libraw_Libraw_getHeight(){
	return librawData->sizes.height;

}
JNIEXPORT jint JNICALL Java_com_deepvi_libraw_Libraw_getOrientation(){
	return librawData->sizes.flip;
}
JNIEXPORT jbyteArray JNICALL Java_com_deepvi_libraw_Libraw_getThumbnail(JNIEnv * env, jobject obj, jstring file){
	cleanup();
	const char *nativeString = (*env)->GetStringUTFChars(env, file, 0);
	librawData=libraw_init(0);
	int result=libraw_open_file(librawData,nativeString);
...
JNIEXPORT jfloatArray JNICALL Java_com_deepvi_libraw_Libraw_getDaylightMultiplier(JNIEnv * env, jobject obj){
...
JNIEXPORT jfloatArray JNICALL Java_com_deepvi_libraw_Libraw_getWhitebalanceMultiplier(JNIEnv * env, jobject obj){
...
JNIEXPORT jfloatArray JNICALL Java_com_deepvi_libraw_Libraw_getCamRgb(JNIEnv * env, jobject obj){
	if(librawData==NULL)
		return NULL;
...
JNIEXPORT jfloatArray JNICALL Java_com_deepvi_libraw_Libraw_getRgbCam(JNIEnv * env, jobject obj){
	float* mul = (float*)librawData->color.rgb_cam;
	jfloatArray jfloatArray = (*env)->NewFloatArray(env, 12);
	(*env)->SetFloatArrayRegion(env, jfloatArray, 0, 12, mul);
	return jfloatArray;
}
JNIEXPORT jfloatArray JNICALL Java_com_deepvi_libraw_Libraw_getCamMatrix(JNIEnv * env, jobject obj){
	float* mul = (float*)librawData->color.cmatrix;
	jfloatArray jfloatArray = (*env)->NewFloatArray(env, 12);
	(*env)->SetFloatArrayRegion(env, jfloatArray, 0, 12, mul);
	return jfloatArray;
}
JNIEXPORT jint JNICALL Java_com_deepvi_libraw_Libraw_getColors(JNIEnv * env, jobject obj){
	return librawData->rawdata.iparams.colors;
}
JNIEXPORT void JNICALL Java_com_deepvi_libraw_Libraw_setUseCameraMatrix(JNIEnv * env, jobject obj,jint use_camera_matrix){
	librawData->params.use_camera_matrix=use_camera_matrix;
}
JNIEXPORT void JNICALL Java_com_deepvi_libraw_Libraw_setQuality(JNIEnv * env, jobject obj,jint quality){
	librawData->params.user_qual=quality;
}
JNIEXPORT void JNICALL Java_com_deepvi_libraw_Libraw_setAutoBrightness(JNIEnv * env, jobject obj,jboolean autoBrightness){
	librawData->params.no_auto_bright=!autoBrightness;
}
JNIEXPORT void JNICALL Java_com_deepvi_libraw_Libraw_setAutoWhitebalance(JNIEnv * env, jobject obj,jboolean autoWhitebalance){
	librawData->params.use_camera_wb=autoWhitebalance;
}
JNIEXPORT void JNICALL Java_com_deepvi_libraw_Libraw_setOutputColorSpace(JNIEnv * env, jobject obj,jint space){
	librawData->params.output_color=space;
}
JNIEXPORT void JNICALL Java_com_deepvi_libraw_Libraw_setHighlightMode(JNIEnv * env, jobject obj,jint highlight){
	librawData->params.highlight=highlight;
}
JNIEXPORT void JNICALL Java_com_deepvi_libraw_Libraw_setOutputBps(JNIEnv * env, jobject obj,jint output_bps){
	librawData->params.output_bps=output_bps;
}
JNIEXPORT void JNICALL Java_com_deepvi_libraw_Libraw_setHalfSize(JNIEnv * env, jobject obj,jboolean half_size){
	librawData->params.half_size=half_size;
}

JNIEXPORT void JNICALL Java_com_deepvi_libraw_Libraw_setUserMul(JNIEnv * env, jobject obj,jfloat r,jfloat g1,jfloat b,jfloat g2){
...
JNIEXPORT void JNICALL Java_com_deepvi_libraw_Libraw_setGamma(JNIEnv * env, jobject obj,jdouble g1,jdouble g2){
...
JNIEXPORT jstring JNICALL Java_com_deepvi_libraw_Libraw_getCameraList(JNIEnv * env, jobject obj){
	jstring result;
...
JNIEXPORT jintArray JNICALL Java_com_deepvi_libraw_Libraw_getPixels8(JNIEnv * env, jobject obj){
	int error;
	image=decode(&error);
	if(image!=NULL){
...
JNIEXPORT jlong JNICALL Java_com_deepvi_libraw_Libraw_getPixels16(JNIEnv * env, jobject obj){
	int error;
	image=decode(&error);
